...
<body>
    <h1 class="text-4xl mb-4 mt-4 text-center font-bold text-blue-600">Create New Type</h1>
    <div class="mt-10">
        <form class="max-w-md mx-auto border-2 border p-4 rounded-2xl" action="{{ route('backend.type.store') }}" method="post">
            @csrf
            <div class="mb-5">
