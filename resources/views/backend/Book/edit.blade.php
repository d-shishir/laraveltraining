...
<body>
<h1 class="text-4xl mb-4 mt-4 text-center font-bold text-blue-600">Edit Book</h1>

<div class="mt-10">
    <form class="max-w-md mx-auto border-2 border p-4 rounded-2xl" action="{{ route('backend.book.update',$book->bookId) }}" method="post">
        @csrf
        <input type="hidden" name="_method" value="PUT">
        <div class="mb-5">
            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
            <input type="text" id="name" value="{{$book->name}}"
